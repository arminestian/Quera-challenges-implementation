...
- The first line contains a single integer `n`, the number of chapters in the report.  
- The second line contains `n` space-separated integers, denoting the number of pages in each chapter.

All numbers in the input are positive integers and are at most `100`.
